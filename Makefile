...
KBUILD_CFLAGS   := -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs \
		   ...
		   -Werror-implicit-function-declaration -Wno-bool-operation \
		   -Wno-format-security -Wno-unused-function -Wno-int-conversion \
		   -std=gnu89
...
ifeq ($(cc-name),clang)
ifneq ($(CROSS_COMPILE),)
CLANG_TRIPLE	?= /home/AzureUser/linux-x86/clang-r353983c1/bin/aarch64-linux-gnu-
